...
class GaussianFourierProjection(nn.Module):
    ...
    def forward(self, t):
        t_proj = t[:, None] * self.W[None, :] * 2 * th.pi
        return th.cat([th.sin(t_proj), th.cos(t_proj)], dim=-1)
...
class ImUNetModel(nn.Module):
    ...
    def __init__(
        ...
        # 替换原有的时间嵌入生成方式
        self.fourier_proj = GaussianFourierProjection(self.model_channels)
    ...
    def forward(self, t, x, y=None):
        ...
        emb = self.time_embed(self.fourier_proj(t))
...
class UNetModelRecFlow(ImUNetModel):
    def __init__(
            self,
            dim,
            num_channels,
